...
class AuthController {
  ...
  Future<void> _createRoleSpecificProfile({
    ...
    if (role == UserRole.supervisor) {
      ...
      // Student: Create minimal initial profile - full details added in CompleteProfilePage
      final initialStudent = StudentProfileModel(
        uid: uid,
        fullName: fullName,
        registrationNumber: 'PENDING',
        program: 'PENDING', // Will be set in complete profile
        academicYear: 0, // Will be set in complete profile
        currentLevel: 'PENDING', // Will be set in complete profile
        createdAt: DateTime.now(),
