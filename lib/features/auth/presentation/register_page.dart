  ...
  Future<void> _register() async {
    ...
    try {
      await ref.read(authControllerProvider).signUp(
        ...
        department: _deptController.text.trim(), // Only used for supervisors
      );
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Department Dropdown (ONLY for supervisors)
                ...
                // Add spacing only if supervisor dropdown is shown
                if (_selectedRole == UserRole.supervisor)
                  const SizedBox(height: 16),
                      ...
                      Expanded(
                        child: Text(
                          _selectedRole == UserRole.student
                              ? 'Your account will be reviewed by an administrator. After approval, you\'ll complete your profile with program details.'
